...
export class PracticeApiService {
  ...
  apiUri:string = this.baseUri+'/practice';
  ...
  // Update Practice
  updatePractice(id, data): Observable<any> {
    let url = `${this.apiUri}/${id}`;
  ...
  // Update Practice
  registerToPractice(id, data): Observable<any> {
  ...
  // Delete Practice
  deletePractice(id): Observable<any> {
    let url = `${this.apiUri}/${id}`;
